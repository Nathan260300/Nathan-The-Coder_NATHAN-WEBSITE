...
console.log("%cDashboard Web de modération. Connexion réservée au staff.","background: #282c34; color: #61dafb; padding: .5em 1em; border-radius: 5px; font-weight: bold;");
